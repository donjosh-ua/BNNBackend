...
def softmax_Bay(tensor, a):
    ...
    if a == 0:
        ...
        prob = np.asarray(
            [[0.60, 0.40, 0.30, 0.23, 0.43, 0.34, 0.45, 0.62, 0.78, 0.24]]
        )  # Probabilidades propuestas por clase
        ...
        Soft_posteriori = Variable(
            torch.FloatTensor(Soft_posteriori), requires_grad=True
        )
